        ...
        {feedbacks.map((card, cardIdx) => {
          return (
            <SwiperSlide key={cardIdx}>
              <div className="grabbing w-full h-full md:max-w-[80%] lg:max-w-[60%] xl:max-w-[40%] md:max-h-[80%] md:rounded-xl md:mx-auto md:mt-[10vh] bg-primary-blue font-secondary">
